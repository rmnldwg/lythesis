...
\begin{figure}
    ...
    \caption[
        ...
        Graphical user interface to analyze lymphatic metastatic progression patterns. This screenshot can be reproduced by following this \superhref{https://re.lyprox.org/06c5c4}{\faIcon{external-link-alt} link} to the frozen version 0.2.9 of \superhref{https://2021-oropharynx.lyprox.org}{\faIcon{external-link-alt} LyProX}.
    }
