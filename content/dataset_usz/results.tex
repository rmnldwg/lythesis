...
\begin{figure}
    ...
    \caption[
        Screenshot of the graphical user interface LyProX
    ]{
        Graphical user interface to analyze lymphatic metastatic progression patterns. This screenshot can be reproduced by following this \superhref{https://2021-oropharynx.lyprox.org/dashboard/?nicotine_abuse=0&hpv_status=0&neck_dissection=-1&n_status=0&central=0&extension=1&subsite__in=base&subsite__in=tonsil&subsite__in=rest&t_stage__in=3&t_stage__in=4&institution__in=1&modalities=0&modalities=1&modalities=2&modalities=3&modality_combine=OR&contra_I=0&contra_Ia=0&contra_Ib=0&contra_II=0&contra_IIa=0&contra_IIb=0&contra_III=0&contra_IV=0&contra_V=0&contra_VII=0&ipsi_I=0&ipsi_Ia=0&ipsi_Ib=0&ipsi_II=1&ipsi_IIa=0&ipsi_IIb=0&ipsi_III=0&ipsi_IV=0&ipsi_V=0&ipsi_VII=0&show_percent=False&render=dashboard}{\faIcon{external-link-alt} link} to the frozen version 0.2.9 of \superhref{https://lyprox.org}{\faIcon{external-link-alt} LyProX}.
    }
...
\begin{table}[!ht]
    \centering
    \caption[
        Prevalence of involvement for various patterns in the patient cohort
    ]{
...
\begin{figure}
    ...
    \caption[
        Involvement statistics for the USZ cohort of OPSCC patients
    ]{
...
\begin{table}[!ht]
    \centering
    \caption[
        Dependence of metastases on upstream level involvement
    ]{
...
\begin{figure}
    ...
    \caption[
        Flowchart of involvements in the ipsilateral LNLs II, III \& IV
    ]{
...
\begin{table}[!hb]
    \centering
    \caption[
        Contralateral prevalences dependent on risk factors
    ]{
    ...
    \resizebox*{\textwidth}{!}{
        \begin{tabular}{|ccc||r|rr|rr|rr|rr|rr|rr|}
            \hline
            T-category & midline & ipsi III & n & \multicolumn{2}{|c|}{I} & \multicolumn{2}{|c|}{II} & \multicolumn{2}{|c|}{III} & \multicolumn{2}{|c|}{IV} & \multicolumn{2}{|c|}{V} & \multicolumn{2}{|c|}{VII} \\ 
            \hline \hline
