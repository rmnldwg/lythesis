\begin{tcolorbox}[
    ...
    \fullcite{ludwig_detailed_2022}.

    \begin{itemize}[leftmargin=5.5mm]
        \item[\faIcon{user}] \textbf{Roman Ludwig*} (me): (Pre-)processing of extracted data; creating figures and tables; managing data repository; development, deployment and maintenance of online interface \superhref{https://lyprox.org}{\faIcon{external-link-alt} LyProX}.
