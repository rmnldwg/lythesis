\begin{tcolorbox}[title=\faIcon{database} Data, parbox=false]
    ...
    Both datasets are available in our repository \repolink{lyDATA} or in the online interface \superhref{https://lyprox.org/patients/dataset/}{\faIcon{external-link-alt} LyProX}.
