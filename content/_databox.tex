\begin{tcolorbox}[title=\faIcon{database} Data, parbox=false]
    ...
    This maximum likelihood estimate was then fed into the model, assuming a sensitivity and specificity of 1. See \cref{chap:dataset_clb} and more specifically \cref{sec:dataset_clb:discussion} for an intuition into our motivations for this simplification.
\end{tcolorbox}
