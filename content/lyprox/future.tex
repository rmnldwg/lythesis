...
Since the patient information displayed in LyProX originates from our public repository \repolink{lyDATA}, it could make sense to automate the process of adding new datasets to the interface's database: Whenever we publish a new cohort on \repolink{lyDATA}, an automated workflow could be triggered that integrates the new list of patients into LyProX.
