...
\begin{figure}
    ...
    \caption[
        ...
        \begin{enumerate*}[label={(\alph*)}]
            ...
            \item metastases in \gls{lnl} VII whereas \gls{lnl} II is healthy
        \end{enumerate*}.
