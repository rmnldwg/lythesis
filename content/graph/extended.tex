...
\begin{figure}
    \centering
    \def\svgwidth{1.04\textwidth}
    \input{figures/extended-connection12-low-prevalences.pdf_tex}
    \caption[
...
\begin{figure}
    \centering
    \def\svgwidth{1.04\textwidth}
    \input{figures/extended-connection12-high-prevalences.pdf_tex}
    \caption[
