...
In this section we have extensively discussed how an anatomically motivated \acrlong{dag} that represents the lymphatic network of the head and neck region and underlies our probabilistic model for \gls{lnl} involvement prediction can be extended to improve that model's performance, while avoiding the pitfalls of overfitting.\looseness=-1
