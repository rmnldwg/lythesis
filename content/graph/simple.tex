...
In this experiment, we performed \acrfull{ti} for each of the four graphs in \cref{fig:graph:simple}, consisting of 64 inverse temperature steps $\beta_i$ spaced according to a fifth order power rule. This means that
%
\begin{equation}
