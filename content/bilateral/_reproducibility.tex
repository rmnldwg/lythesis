\begin{tcolorbox}[title=\faIcon{recycle} Reproducibility, parbox=false]
    ...
    \begin{itemize}
        \item Model $\mathcal{M}_\text{ag}$: \lytag{bilateral-v2}
        \item Model $\mathcal{M}_\alpha$: \lytag{midline-with-mixing-v2}
        \item Model $\mathcal{M}_\text{full}$: \lytag{midline-without-mixing-v2}
    \end{itemize}
\end{tcolorbox}
