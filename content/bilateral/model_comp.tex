...
\begin{table}
    ...
    \begin{tabular}{|l|S|S|S|}
        \hline
        \multicolumn{1}{|c|}{Metric} & \multicolumn{1}{c|}{agnostic $\mathcal{M}_\text{ag}$} & \multicolumn{1}{c|}{mixing $\mathcal{M}_\alpha$} & \multicolumn{1}{c|}{full $\mathcal{M}_\text{full}$} \\
        \hline
